...
The thruster geometry is configured in the `THRUSTERS` table inside `rov_simulator.py` so you can quickly tune positions/angles to match hardware revisions.
